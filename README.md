...
[Why do you want to run WebAssembly on the server-side?](https://docs.secondstate.io/server-side-webassembly/the-case-for-webassembly-on-the-server-side?utm_source=github&utm_medium=documents&utm_campaign=Github-ssvm-readme)
