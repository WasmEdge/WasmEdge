...
1. Send email to <security@secondstate.io>
...
WasmEdge follows a **`TODO: X days` disclosure timeline**. Refer to our [embargo policy](./docs/embargo-policy.md) for more information.
