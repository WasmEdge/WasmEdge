...
/*
 * Class:     org_wasmedge_WasmEdgeVM
 * Method:    getImportModuleContext
 * Signature: (Lorg/wasmedge/enums/HostRegistration;)Lorg/wasmedge/ImportObjectContext;
 */
JNIEXPORT jobject JNICALL Java_org_wasmedge_WasmEdgeVM_getImportModuleContext
  (JNIEnv *, jobject, jobject);
