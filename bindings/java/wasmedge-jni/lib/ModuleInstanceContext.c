...
JNIEXPORT jint JNICALL Java_org_wasmedge_ModuleInstanceContext_getWASIExitCode
    ...
    return WasmEdge_ModuleInstanceWASIGetExitCode(getModuleInstanceContext(env, thisObject));
}
...
(JNIEnv *env, jobject thisObject, jobjectArray jAllowedCmds, jboolean jAllowAll) {
    ...
    WasmEdge_ModuleInstanceInitWasmEdgeProcess(allowedCmds, (*env)->GetArrayLength(env, jAllowedCmds), jAllowAll);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_listFunction
        (JNIEnv *env, jobject thisObject) {
    WasmEdge_ModuleInstanceContext *moduleInstanceContext = getModuleInstanceContext(env, thisObject);

    uint32_t funcLen = WasmEdge_ModuleInstanceListFunctionLength(moduleInstanceContext);
    WasmEdge_String* nameList = (WasmEdge_String*)malloc(sizeof (struct WasmEdge_String) * funcLen);
    uint32_t RealFuncNum = WasmEdge_ModuleInstanceListFunction(moduleInstanceContext, nameList, funcLen);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_findFunction
    ...
    WasmEdge_FunctionInstanceContext * funcInstance = WasmEdge_ModuleInstanceFindFunction(moduleInstanceContext, wFuncName);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_listTable
    ...
    uint32_t tabLen = WasmEdge_ModuleInstanceListTableLength(moduleInstanceContext);
    WasmEdge_String *nameList = (WasmEdge_String *) malloc(sizeof(struct WasmEdge_String) * tabLen);
    uint32_t RealTabNum = WasmEdge_ModuleInstanceListTable(moduleInstanceContext, nameList, tabLen);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_findTable
    ...
    WasmEdge_TableInstanceContext * tabInst = WasmEdge_ModuleInstanceFindTable(moduleInstanceContext, wTabName);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_listMemory
    ...
    uint32_t memLen = WasmEdge_ModuleInstanceListMemoryLength(moduleInstanceContext);
    WasmEdge_String* nameList = (WasmEdge_String*)malloc(sizeof (struct WasmEdge_String) * memLen);
    uint32_t RealMemNum = WasmEdge_ModuleInstanceListMemory(moduleInstanceContext, nameList, memLen);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_findMemory
    ...
    WasmEdge_MemoryInstanceContext * memInst = WasmEdge_ModuleInstanceFindMemory(moduleInstanceContext, wMemName);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_listGlobal
        (JNIEnv *env, jobject thisObject) {
    WasmEdge_ModuleInstanceContext *moduleInstanceContext = getModuleInstanceContext(env, thisObject);
    uint32_t globLen = WasmEdge_ModuleInstanceListGlobalLength(moduleInstanceContext);
    WasmEdge_String* nameList = (WasmEdge_String*)malloc(sizeof (struct WasmEdge_String) * globLen);
    uint32_t RealGlobNum = WasmEdge_ModuleInstanceListGlobal(moduleInstanceContext, nameList, globLen);
...
JNIEXPORT jobject JNICALL Java_org_wasmedge_ModuleInstanceContext_findGlobal
    ...
    WasmEdge_GlobalInstanceContext * globInst = WasmEdge_ModuleInstanceFindGlobal(moduleInstanceContext, wGlobName);
