...
> WasmEdge Runtime 需要最新版本的 `libstdc++`。 Ubuntu 20.04 LTS 已经有最新的库了。 如果你使用的是比较老的 Linux 发行版中，有一些选项需要升级，[更详细的信息在这儿](https://www.secondstate.iohttps://www.secondstate.io/articles/ubuntu-req-ssvm-20200715/)。
