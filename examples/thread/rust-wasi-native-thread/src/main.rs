...
#[link(wasm_import_module = "wasmedge_thread")]
extern "C" {
  pub fn pthread_create(
    newthread: *mut i32,
    attr: *const pthread_attr_t,
    start_routine: extern "C" fn(data: *mut c_void) -> *mut c_void,
    arg: *mut c_void,
  ) -> i32;
  pub fn pthread_join(th: i32, thread_return: *mut *mut c_void) -> i32;
}
...
fn main() {
  let mut threads: Vec<i32> = Vec::new();
