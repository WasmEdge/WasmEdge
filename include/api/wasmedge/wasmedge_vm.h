...
/// instance, release references from a prior rapid run first, or they pin
...
/// `WasmEdge_VMReleaseRef`; any never handed back (overflowed, or an
/// externalized externref) only via `WasmEdge_VMReleaseAllRefs`.
///
/// This function is thread-safe.
///
/// \param Cxt the WasmEdge_VMContext.
