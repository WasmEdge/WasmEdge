...
enum class OpCode : uint16_t {
  ...
  I32__atomic_load_s = 0XFE10,
  I64__atomic_load_s = 0XFE11,
  I32__atomic_load8_u = 0XFE12,
  I32__atomic_load16_u = 0XFE13,
  I64__atomic_load8_u = 0XFE14,
  I64__atomic_load16_u = 0XFE15,
  I64__atomic_load32_u = 0XFE16,
  I32__atomic_store_s = 0XFE17,
  I64__atomic_store_s = 0XFE18,
  I32__atomic_store8_u = 0XFE19,
  I32__atomic_store16_u = 0XFE1A,
  I64__atomic_store8_u = 0XFE1B,
  I64__atomic_store16_u = 0XFE1C,
  I64__atomic_store32_u = 0XFE1D,
  I32__atomic_add_s = 0XFE1E,
  I64__atomic_add_s = 0XFE1F,
  I32__atomic_add8_u = 0XFE20,
  I32__atomic_add16_u = 0XFE21,
  I64__atomic_add8_u = 0XFE22,
  I64__atomic_add16_u = 0XFE23,
  I64__atomic_add32_u = 0XFE24,
  I32__atomic_sub_s = 0XFE25,
  I64__atomic_sub_s = 0XFE26,
  I32__atomic_sub8_u = 0XFE27,
  I32__atomic_sub16_u = 0XFE28,
  I64__atomic_sub8_u = 0XFE29,
  I64__atomic_sub16_u = 0XFE2A,
  I64__atomic_sub32_u = 0XFE2B,
  I32__atomic_and_s = 0XFE2C,
  I64__atomic_and_s = 0XFE2D,
  I32__atomic_and8_u = 0XFE2E,
  I32__atomic_and16_u = 0XFE2F,
  I64__atomic_and8_u = 0XFE30,
  I64__atomic_and16_u = 0XFE31,
  I64__atomic_and32_u = 0XFE32,
  I32__atomic_or_s = 0XFE33,
  I64__atomic_or_s = 0XFE34,
  I32__atomic_or8_u = 0XFE35,
  I32__atomic_or16_u = 0XFE36,
  I64__atomic_or8_u = 0XFE37,
  I64__atomic_or16_u = 0XFE38,
  I64__atomic_or32_u = 0XFE39,
  I32__atomic_xor_s = 0XFE3A,
  I64__atomic_xor_s = 0XFE3B,
  I32__atomic_xor8_u = 0XFE3C,
  I32__atomic_xor16_u = 0XFE3D,
  I64__atomic_xor8_u = 0XFE3E,
  I64__atomic_xor16_u = 0XFE3F,
  I64__atomic_xor32_u = 0XFE40,
  I32__atomic_xchg_s = 0XFE41,
  I64__atomic_xchg_s = 0XFE42,
  I32__atomic_xchg8_u = 0XFE43,
  I32__atomic_xchg16_u = 0XFE44,
  I64__atomic_xchg8_u = 0XFE45,
  I64__atomic_xchg16_u = 0XFE46,
  I64__atomic_xchg32_u = 0XFE47,
  I32__atomic_cmpxchg_s = 0XFE48,
  I64__atomic_cmpxchg_s = 0XFE49,
  I32__atomic_cmpxchg8_u = 0XFE4A,
  I32__atomic_cmpxchg16_u = 0XFE4B,
  I64__atomic_cmpxchg8_u = 0XFE4C,
  I64__atomic_cmpxchg16_u = 0XFE4D,
  I64__atomic_cmpxchg32_u = 0XFE4E
};
...
static inline std::unordered_map<OpCode, std::string> OpCodeStr = {
    ...
    {OpCode::I32__atomic_load_s, "i32.atomic.load"},
    {OpCode::I64__atomic_load_s, "i64.atomic.load"},
    {OpCode::I32__atomic_load8_u, "i32.atomic.load8_u"},
    {OpCode::I32__atomic_load16_u, "i32.atomic.load16_u"},
    {OpCode::I64__atomic_load8_u, "i64.atomic.load8_u"},
    {OpCode::I64__atomic_load16_u, "i64.atomic.load16_u"},
    {OpCode::I64__atomic_load32_u, "i64.atomic.load32_u"},
    {OpCode::I32__atomic_store_s, "i32.atomic.store"},
    {OpCode::I64__atomic_store_s, "i64.atomic.store"},
    {OpCode::I32__atomic_store8_u, "i32.atomic.store8_u"},
    {OpCode::I32__atomic_store16_u, "i32.atomic.store16_u"},
    {OpCode::I64__atomic_store8_u, "i64.atomic.store8_u"},
    {OpCode::I64__atomic_store16_u, "i64.atomic.store16_u"},
    {OpCode::I64__atomic_store32_u, "i64.atomic.store32_u"},
    {OpCode::I32__atomic_add_s, "i32.atomic.rmw.add"},
    {OpCode::I64__atomic_add_s, "i64.atomic.rmw.add"},
    {OpCode::I32__atomic_add8_u, "i32.atomic.rmw8.add_u"},
    {OpCode::I32__atomic_add16_u, "i32.atomic.rmw16.add_u"},
    {OpCode::I64__atomic_add8_u, "i64.atomic.rmw8.add_u"},
    {OpCode::I64__atomic_add16_u, "i64.atomic.rmw16.add_u"},
    {OpCode::I64__atomic_add32_u, "i64.atomic.rmw32.add_u"},
    {OpCode::I32__atomic_sub_s, "i32.atomic.rmw.sub"},
    {OpCode::I64__atomic_sub_s, "i64.atomic.rmw.sub"},
    {OpCode::I32__atomic_sub8_u, "i32.atomic.rmw8.sub_u"},
    {OpCode::I32__atomic_sub16_u, "i32.atomic.rmw16.sub_u"},
    {OpCode::I64__atomic_sub8_u, "i64.atomic.rmw8.sub_u"},
    {OpCode::I64__atomic_sub16_u, "i64.atomic.rmw16.sub_u"},
    {OpCode::I64__atomic_sub32_u, "i64.atomic.rmw32.sub_u"},
    {OpCode::I32__atomic_and_s, "i32.atomic.rmw.and"},
    {OpCode::I64__atomic_and_s, "i64.atomic.rmw.and"},
    {OpCode::I32__atomic_and8_u, "i32.atomic.rmw8.and_u"},
    {OpCode::I32__atomic_and16_u, "i32.atomic.rmw16.and_u"},
    {OpCode::I64__atomic_and8_u, "i64.atomic.rmw8.and_u"},
    {OpCode::I64__atomic_and16_u, "i64.atomic.rmw16.and_u"},
    {OpCode::I64__atomic_and32_u, "i64.atomic.rmw32.and_u"},
    {OpCode::I32__atomic_or_s, "i32.atomic.rmw.or"},
    {OpCode::I64__atomic_or_s, "i64.atomic.rmw.or"},
    {OpCode::I32__atomic_or8_u, "i32.atomic.rmw8.or_u"},
    {OpCode::I32__atomic_or16_u, "i32.atomic.rmw16.or_u"},
    {OpCode::I64__atomic_or8_u, "i64.atomic.rmw8.or_u"},
    {OpCode::I64__atomic_or16_u, "i64.atomic.rmw16.or_u"},
    {OpCode::I64__atomic_or32_u, "i64.atomic.rmw32.or_u"},
    {OpCode::I32__atomic_xor_s, "i32.atomic.rmw.xor"},
    {OpCode::I64__atomic_xor_s, "i64.atomic.rmw.xor"},
    {OpCode::I32__atomic_xor8_u, "i32.atomic.rmw8.xor_u"},
    {OpCode::I32__atomic_xor16_u, "i32.atomic.rmw16.xor_u"},
    {OpCode::I64__atomic_xor8_u, "i64.atomic.rmw8.xor_u"},
    {OpCode::I64__atomic_xor16_u, "i64.atomic.rmw16.xor_u"},
    {OpCode::I64__atomic_xor32_u, "i64.atomic.rmw32.xor_u"},
    {OpCode::I32__atomic_xchg_s, "i32.atomic.rmw.xchg"},
    {OpCode::I64__atomic_xchg_s, "i64.atomic.rmw.xchg"},
    {OpCode::I32__atomic_xchg8_u, "i32.atomic.rmw8.xchg_u"},
    {OpCode::I32__atomic_xchg16_u, "i32.atomic.rmw16.xchg_u"},
    {OpCode::I64__atomic_xchg8_u, "i64.atomic.rmw8.xchg_u"},
    {OpCode::I64__atomic_xchg16_u, "i64.atomic.rmw16.xchg_u"},
    {OpCode::I64__atomic_xchg32_u, "i64.atomic.rmw32.xchg_u"},
    {OpCode::I32__atomic_cmpxchg_s, "i32.atomic.rmw.cmpxchg"},
    {OpCode::I64__atomic_cmpxchg_s, "i64.atomic.rmw.cmpxchg"},
    {OpCode::I32__atomic_cmpxchg8_u, "i32.atomic.rmw8.cmpxchg_u"},
    {OpCode::I32__atomic_cmpxchg16_u, "i32.atomic.rmw16.cmpxchg_u"},
    {OpCode::I64__atomic_cmpxchg8_u, "i64.atomic.rmw8.cmpxchg_u"},
    {OpCode::I64__atomic_cmpxchg16_u, "i64.atomic.rmw16.cmpxchg_u"},
    {OpCode::I64__atomic_cmpxchg32_u, "i64.atomic.rmw32.cmpxchg_u"}};
} // namespace WasmEdge
