...
public:
  Expect<void> body(Runtime::Instance::MemoryInstance &MemInst,
                    ...
                    uint32_t InANDim, uint32_t InADimsOff, uint32_t InBOff,
                    uint32_t InBNDim, uint32_t InBDimsOff, uint32_t OutCOff,
...
public:
  Expect<void> body(Runtime::Instance::MemoryInstance &MemInst,
                    ...
                    uint32_t InXNDim, uint32_t InXDimsOff, uint32_t OutYOff,
...
public:
  Expect<void>
  body(Runtime::Instance::MemoryInstance &MemInst, uint32_t RuntimeContextOff,
       uint32_t InXOff, uint32_t InXNDim, uint32_t InXDimsOff,
       uint32_t InScaleOff, uint32_t InScaleNDim, uint32_t InScaleDimsOff,
       uint32_t InBOff, uint32_t InBNDim, uint32_t InBDimsOff,
       uint32_t InMeanOff, uint32_t InMeanNDim, uint32_t InMeanDimsOff,
       uint32_t InVarOff, uint32_t InVarNDim, uint32_t InVarDimsOff,
       uint32_t OutYOff, uint32_t OutYNDim, uint32_t OutYDimsOff,
       uint32_t OutMeanOff, uint32_t OutMeanNDim, uint32_t OutMeanDimsOff,
       uint32_t OutVarOff, uint32_t OutVarNDim, uint32_t OutVarDimsOff,
       uint32_t OutSavedMeanOff, uint32_t OutSavedMeanNDim,
...
public:
  Expect<void> body(Runtime::Instance::MemoryInstance &MemInst,
                    uint32_t RuntimeContextOff, uint32_t InAOff,
                    uint32_t InANDim, uint32_t InADimsOff, uint32_t InBOff,
                    uint32_t InBNDim, uint32_t InBDimsOff, uint32_t InCOff,
                    uint32_t InCNDim, uint32_t InCDimsOff, uint32_t OutYOff,
                    uint32_t OutYNDim, uint32_t OutYDimsOff, float Alpha,
                    float Beta, uint32_t TransA, uint32_t TransB);
};
...
public:
  Expect<void> body(Runtime::Instance::MemoryInstance &MemInst,
                    ...
                    uint32_t InXNDim, uint32_t InXDimsOff, uint32_t OutYOff,
                    uint32_t OutYNDim, uint32_t OutYDimsOff, float Alpha,
                    float Beta, float Bias, uint32_t Size);
};
...
public:
  Expect<void> body(Runtime::Instance::MemoryInstance &MemInst,
                    ...
                    uint32_t OutExpandedDimsOff, uint32_t AxesOff,
                    uint32_t AxesNum);
};
