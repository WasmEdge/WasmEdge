...
//===-- wasi_crypto/asymmetric_common/func.h - Asymmetric common func -----===//
//
...
///
/// \file
/// This file contains the asymmetric common func module of wasi-crypto
///
//===----------------------------------------------------------------------===//
#pragma once
...
public:
  ...
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        ...
                        uint32_t Encoding, uint32_t /* Out */ KpHandlePtr);
};
...
public:
  using HostFunction::HostFunction;
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        int32_t KpHandle, uint32_t KpIdPtr, uint32_t KpIdMaxLen,
