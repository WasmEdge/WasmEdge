...
//===-- wasi_crypto/symmetric/func.h - Symmetric func ---------------------===//
//
...
///
/// \file
/// This file contains the symmetric func module of wasi-crypto
///
//===----------------------------------------------------------------------===//
#pragma once
...
public:
  ...
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        uint32_t AlgPtr, uint32_t AlgLen, uint32_t RawPtr,
                        uint32_t RawLen, uint32_t /* Out */ KeyHandlePtr);
};
...
public:
  ...
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        uint32_t AlgPtr, uint32_t AlgLen,
                        uint32_t OptKeyHandlePtr, uint32_t OptOptionsPtr,
...
public:
  ...
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        int32_t StateHandle, uint32_t OutPtr, uint32_t OutLen);
};
...
public:
  ...
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        int32_t StateHandle, uint32_t OutPtr, uint32_t OutLen,
                        uint32_t DataPtr, uint32_t DataLen, uint32_t RawTagPtr,
...
public:
  ...
  Expect<uint32_t> body(Runtime::Instance::MemoryInstance *MemInst,
                        int32_t TagHandle, uint32_t BufPtr, uint32_t BufLen,
                        uint32_t /* Out */ SizePtr);
};
