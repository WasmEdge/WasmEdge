...
private:
  ...
  /// serialize sections functions
  std::vector<uint8_t> serializeCustomSection(AST::CustomSection &CustomSecs);
  ...
  std::vector<uint8_t> serializeGlobalSection(AST::GlobalSection &GlobSec);
  ...
  std::vector<uint8_t> serializeElementSection(AST::ElementSection &ElemSec);
  std::vector<uint8_t> serializeCodeSection(AST::CodeSection &CodeSec);
  std::vector<uint8_t> serializeDataSection(AST::DataSection &DataSec);
  std::vector<uint8_t>
