...
/// The component model store: the named component instances, host component
/// functions, and component definitions. It owns none of them.
class StoreManager {
public:
  ...
  /// imports of a root instantiation, for a test harness or an embedder; the
  /// definition is read when an instantiation reads it, which copies what it
  /// keeps.
