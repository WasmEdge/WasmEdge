...
using PNT_TIB_ = NT_TIB_ *;

#if defined(_M_X64)
#if defined(__GNUC__) || defined(__clang__)
WASMEDGE_WINAPI_FORCEINLINE static inline uint64_t
...
#if defined(__GNUC__) || defined(__clang__)
WASMEDGE_WINAPI_FORCEINLINE static inline uint32_t
...
#endif
static inline PTEB_ NtCurrentTeb(void) noexcept {
  return reinterpret_cast<PTEB_>(__readfsdword(offsetof(_NT_TIB, Self)));
}
