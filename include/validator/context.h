...
public:
  struct ComponentContext {
    ...
    std::unordered_map<uint32_t, std::vector<AST::Component::ExportDecl>>
        ComponentInstanceExports;
    std::unordered_map<uint32_t, std::vector<AST::ExportDesc>>
        CoreInstanceExports;
  ...
  void addComponentInstanceExport(uint32_t InstanceIdx,
                                  const AST::Component::ExportDecl &E) {
    auto &Ctx = getCurrentContext();
    Ctx.ComponentInstanceExports[InstanceIdx].push_back(E);
  }

  std::vector<AST::Component::ExportDecl>
  ...
  void addCoreInstanceExport(uint32_t InstanceIdx, const AST::ExportDesc &E) {
    auto &Ctx = getCurrentContext();
    Ctx.CoreInstanceExports[InstanceIdx].push_back(E);
  }

  std::vector<AST::ExportDesc>
