...
// Layout leaves that the load and store paths reach for.
// Defined in component_canon_layout.cpp.
...
// Value hygiene and traps.
// Defined in component_canon_loadstore.cpp.
...
// Representation primitives: the conversions between a component value and
// its handle-table or linear-memory form. Defined in
// component_canon_loadstore.cpp.
