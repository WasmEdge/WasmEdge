  ...
  for (const auto &Alias : AliasSec.getContent()) {
    ...
    case AST::Component::Alias::TargetType::Export: {
      ...
      case AST::Component::Sort::SortType::Func: {
        ...
        if (Func == nullptr) {
          return logUnknownError("func"sv, Name, From, ASTNodeAttr::Comp_Alias);
        }
      ...
      case AST::Component::Sort::SortType::Value: {
        ...
        if (Val == nullptr) {
          return logUnknownError("value"sv, Name, From,
                                 ASTNodeAttr::Comp_Alias);
        }
      ...
      case AST::Component::Sort::SortType::Type: {
        ...
        if (TypeDef == nullptr) {
          return logUnknownError("type"sv, Name, From, ASTNodeAttr::Comp_Alias);
        }
    ...
    case AST::Component::Alias::TargetType::CoreExport: {
      ...
      case AST::Component::Sort::CoreSortType::Func: {
        ...
        if (Func == nullptr) {
          return logUnknownError("core func"sv, Name, From,
                                 ASTNodeAttr::Comp_Alias);
        }
      ...
      case AST::Component::Sort::CoreSortType::Table: {
        ...
        if (Tab == nullptr) {
          return logUnknownError("core table"sv, Name, From,
                                 ASTNodeAttr::Comp_Alias);
        }
      ...
      case AST::Component::Sort::CoreSortType::Memory: {
        ...
        if (Mem == nullptr) {
          return logUnknownError("core memory"sv, Name, From,
                                 ASTNodeAttr::Comp_Alias);
        }
      ...
      case AST::Component::Sort::CoreSortType::Global: {
        ...
        if (Glob == nullptr) {
          return logUnknownError("core global"sv, Name, From,
                                 ASTNodeAttr::Comp_Alias);
        }
      ...
      case AST::Component::Sort::CoreSortType::Tag: {
        ...
        if (Tag == nullptr) {
          return logUnknownError("core tag"sv, Name, From,
                                 ASTNodeAttr::Comp_Alias);
        }
