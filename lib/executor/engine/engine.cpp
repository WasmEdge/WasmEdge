...
Expect<void> Executor::execute(Runtime::StackManager &StackMgr,
  ...
  auto Dispatch = [this, &PC, &StackMgr]() -> Expect<void> {
    ...
    case OpCode::Struct__get_u:
      return runStructGetOp(StackMgr, Instr.getSourceIndex(), GetDstCompType(),
                            Instr);
    case OpCode::Struct__get_s:
      return runStructGetOp(StackMgr, Instr.getSourceIndex(), GetDstCompType(),
                            Instr, true);
    case OpCode::Struct__set:
      return runStructSetOp(StackMgr, GetDstCompType(), Instr.getSourceIndex(),
                            Instr);
    ...
    case OpCode::Array__get_u:
      return runArrayGetOp(StackMgr, GetDstCompType(), Instr);
    case OpCode::Array__get_s:
      return runArrayGetOp(StackMgr, GetDstCompType(), Instr, true);
    case OpCode::Array__set:
      return runArraySetOp(StackMgr, GetDstCompType(), Instr);
    case OpCode::Array__len:
      return runArrayLenOp(StackMgr, Instr);
    case OpCode::Array__fill:
      return runArrayFillOp(StackMgr, GetDstCompType(), Instr);
    case OpCode::Array__copy:
      return runArrayCopyOp(StackMgr, GetSrcCompType(), GetDstCompType(),
                            Instr);
    case OpCode::Array__init_data:
      return runArrayInitDataOp(
          StackMgr, GetDstCompType(),
    ...
    case OpCode::I32x4__dot_i16x8_s: {
      ...
      StackMgr.emplaceTop<int32x4_t>(Result);
      return {};
#else
