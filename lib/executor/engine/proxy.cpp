...
Executor::proxyTableGrow(Runtime::StackManager &,
  ...
  // Read the pre-grow size INSIDE growTable's exclusive window: a
  // controller-backed grow stops the world, so a size read out here could race
  // a concurrent serialized grow.
