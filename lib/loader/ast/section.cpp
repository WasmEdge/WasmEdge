...
Expect<void> Loader::loadSection(FileMgr &VecMgr, AST::AOTSection &Sec) {
  ...
  // R7-M3 durable capability: whether this artifact was compiled with GC
  // codegen. Written by outputWasmLibrary from the presence of the
  // "gc.capable" marker global.
