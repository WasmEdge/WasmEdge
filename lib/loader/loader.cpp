...
Loader::parseWasmUnit(const std::filesystem::path &FilePath) {
  ...
  // Detect WAT text over the mapped bytes, avoiding a full read just for
  // detection: maybeWAT rejects a WASM/AOT binary after its first page.
