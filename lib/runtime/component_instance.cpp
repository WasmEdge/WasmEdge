...
uint32_t ComponentInstance::getLastTypeIndex() noexcept {
  return static_cast<uint32_t>(Types.size() - 1);
}
uint32_t ComponentInstance::typeToIndex(DefType Ty) noexcept {
  addType(Ty);
