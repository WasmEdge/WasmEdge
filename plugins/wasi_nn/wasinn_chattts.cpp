...
#endif
Expect<WASINN::ErrNo> load([[maybe_unused]] WASINN::WasiNNEnvironment &Env,
                           WASINN::Graph &G, Span<const Span<uint8_t>>,
...
Expect<WASINN::ErrNo>
initExecCtx([[maybe_unused]] WasiNNEnvironment &Env,
...
Expect<WASINN::ErrNo> setInput([[maybe_unused]] WasiNNEnvironment &Env,
...
Expect<WASINN::ErrNo> getOutput([[maybe_unused]] WasiNNEnvironment &Env,
                                WASINN::Graph &G, WASINN::Context &C,
...
Expect<WASINN::ErrNo> compute([[maybe_unused]] WasiNNEnvironment &Env,
