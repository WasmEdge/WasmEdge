...
Expect<WASINN::ErrNo> load([[maybe_unused]] WASINN::WasiNNEnvironment &Env,
                           WASINN::Graph &G, Span<const Span<uint8_t>> Builders,
                           [[maybe_unused]] WASINN::Device Device) noexcept {
...
Expect<WASINN::ErrNo>
initExecCtx([[maybe_unused]] WASINN::WasiNNEnvironment &Env,
            [[maybe_unused]] WASINN::Graph &G,
            [[maybe_unused]] WASINN::Context &C) noexcept {
  return WASINN::ErrNo::Success;
}

Expect<WASINN::ErrNo> setInput([[maybe_unused]] WASINN::WasiNNEnvironment &Env,
