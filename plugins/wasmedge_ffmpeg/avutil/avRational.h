...
public:
  ...
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,int32_t ANum,int32_t ADen,int32_t BNum,int32_t BDen,uint32_t CNumPtr,uint32_t CDenPtr);
};
...
public:
  AVCmpQ(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,int32_t ANum,int32_t ADen,int32_t BNum,int32_t BDen);
};
...
public:
  AVNearerQ(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,int32_t ANum,int32_t ADen,int32_t BNum,int32_t BDen,int32_t CNum,int32_t CDen);
};
...
public:
  AVQ2d(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<double_t> body(const Runtime::CallingFrame &Frame,int32_t ANum,int32_t ADen);
};
...
public:
  AVD2Q(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,double_t D,int32_t Max,uint32_t ANumPtr,uint32_t ADenPtr);
};
...
public:
  AVQ2IntFloat(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<uint32_t> body(const Runtime::CallingFrame &Frame,int32_t ANum,int32_t ADen);
};
...
public:
  AVInvQ(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,int32_t ANum,int32_t ADen,uint32_t BNumPtr, uint32_t BDenPtr);
};
...
public:
  AVReduce(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t ANumPtr,uint32_t ADenPtr,int64_t BNum,int64_t BDen,int64_t Max);
};
