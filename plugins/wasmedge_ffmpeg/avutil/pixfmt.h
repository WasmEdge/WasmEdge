...
//  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t AvPixFmtId, uint32_t AvPixFmtDescPtr);
//};

class AvPixFmtDescriptorNbComponents : public WasmEdgeFFmpegAVUtil<AvPixFmtDescriptorNbComponents> {
public:
...
class AvPixFmtDescriptorLog2ChromaW : public WasmEdgeFFmpegAVUtil<AvPixFmtDescriptorLog2ChromaW> {
public:
...
class AvPixFmtDescriptorLog2ChromaH : public WasmEdgeFFmpegAVUtil<AvPixFmtDescriptorLog2ChromaH> {
public:
...
//
//class AvPixFmtDescriptorName : public WasmEdgeFFmpegAVUtil<AvPixFmtDescriptorName> {
//public:
