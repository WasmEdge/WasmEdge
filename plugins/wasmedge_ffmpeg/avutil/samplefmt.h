...
public:
  ...
  Expect<uint32_t> body(const Runtime::CallingFrame &Frame,uint32_t SampleFormatId);
};
...
public:
  AVGetBytesPerSample(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t SampleFormatId);
};
...
public:
  AVGetSampleFmt(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t Str,uint32_t StrLen);
};

class AVSamplesGetBufferSize : public WasmEdgeFFmpegAVUtil<AVSamplesGetBufferSize> {
public:
  AVSamplesGetBufferSize(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,int32_t NbChannels,int32_t NbSamples,uint32_t SampleFormatId,int32_t Align);
};

class AVSamplesAllocArrayAndSamples : public WasmEdgeFFmpegAVUtil<AVSamplesAllocArrayAndSamples> {
public:
  AVSamplesAllocArrayAndSamples(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t BufferPtr,int32_t LinesizeValue,int32_t NbChannels,int32_t NbSamples,uint32_t SampleFmtId,int32_t Align);
};
...
public:
  AVSamplesGetBuffer(std::shared_ptr<WasmEdgeFFmpegEnv> HostEnv)
      : WasmEdgeFFmpegAVUtil(HostEnv) {}
  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t BufferID,uint32_t BufferPtr,uint32_t BufferSize);
};
...
//      : WasmEdgeFFmpegAVUtil(HostEnv) {}
//  Expect<int32_t> body(const Runtime::CallingFrame &Frame,uint32_t DestBufPtr,uint32_t SrcBufId,int32_t DestOffset,int32_t SourceOffset,int32_t NbSamples,int32_t NbChannels,uint32_t SampleFmtId);
//};
//
