...
WasmEdgeFFmpegSWScaleModule(std::shared_ptr<WasmEdgeFFmpegEnv> Env)
    ...
    addHostFunc("wasmedge_ffmpeg_swscale_sws_getLumaH",std::make_unique<SwsGetLumaH>(Env));
    addHostFunc("wasmedge_ffmpeg_swscale_sws_getLumaV",std::make_unique<SwsGetLumaV>(Env));
    addHostFunc("wasmedge_ffmpeg_swscale_sws_getChromaH",std::make_unique<SwsGetChromaH>(Env));
    addHostFunc("wasmedge_ffmpeg_swscale_sws_getChromaV",std::make_unique<SwsGetChromaV>(Env));
    ...
    addHostFunc("wasmedge_ffmpeg_swscale_sws_getCoeffVecLength",std::make_unique<SwsGetCoeffVecLength>(Env));
    addHostFunc("wasmedge_ffmpeg_swscale_sws_getCoeff",std::make_unique<SwsGetCoeff>(Env));
