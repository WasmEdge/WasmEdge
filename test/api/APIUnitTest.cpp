...
WasmEdge_ASTModuleContext *loadModule
    [[maybe_unused]] (const WasmEdge_ConfigureContext *Conf, const char *Path) {
...
bool validateModule [[maybe_unused]] (const WasmEdge_ConfigureContext *Conf,
...
WasmEdge_ModuleInstanceContext *registerModule
    [[maybe_unused]] (const WasmEdge_ConfigureContext *Conf,
...
bool registerModule [[maybe_unused]] (const WasmEdge_ConfigureContext *Conf,
                                      WasmEdge_StoreContext *Store,
...
WasmEdge_ModuleInstanceContext *instantiateModule
    [[maybe_unused]] (const WasmEdge_ConfigureContext *Conf,
                      WasmEdge_StoreContext *Store,
                      const WasmEdge_ASTModuleContext *Mod) {
  WasmEdge_ExecutorContext *ExecCxt = WasmEdge_ExecutorCreate(Conf, nullptr);
