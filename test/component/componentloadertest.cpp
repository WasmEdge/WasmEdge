...
TEST(ComponentLoader, LoadVariantWithRefinesByIndex) {
  ...
  std::vector<uint8_t> Vec = {
    0x00, 0x61, 0x73, 0x6d, 0x0d, 0x00, 0x01, 0x00, 0x07, 0x13, 0x01, 0x71,
    0x03, 0x01, 0x78, 0x00, 0x00, 0x01, 0x79, 0x01, 0x73, 0x01, 0x00, 0x01,
...
TEST(ComponentLoader, LoadVariantWithoutRefines) {
  ...
  // (type (variant (case "x")))
  std::vector<uint8_t> Vec = {
    0x00, 0x61, 0x73, 0x6d, 0x0d, 0x00, 0x01, 0x00, 0x07, 0x07, 0x01, 0x71,
