...
// A host component function over a lambda, for the hand-built host items the
// reference suites import.
class HostFunc : public Runtime::Component::HostFunctionBase {
public:
  using Body = std::function<Expect<void>(Span<const ComponentValVariant>,
                                          Span<ComponentValVariant>)>;
  HostFunc(AST::Component::FuncType &&FnType, Body B) : Fn(std::move(B)) {
    DeclType = std::move(FnType);
  }
  Expect<void> run(Runtime::Component::CallingFrame &,
...
TEST_P(CoreTest, TestSuites) {
  ...
  struct TestContext {
    ...
    void registerComponentHostItems() {
      ...
      const uint32_t OwnIdx = Host->addType(std::move(OwnR1));
      ...
      Host->addHostFunc("[constructor]resource1",
                        std::make_unique<HostFunc>(
                            std::move(*Ctor),
                            [](Span<const ComponentValVariant> Args,
                               Span<ComponentValVariant> Rets) -> Expect<void> {
                              Rets[0] = makeComponentVal(
                                  OwnVal{std::get<uint32_t>(Args[0])});
                              return {};
                            }));
      ...
      auto Assert = std::make_unique<FuncType>(
          ...
          std::vector<LabelValType>{});
      Host->addHostFunc("[static]resource1.assert",
                        std::make_unique<HostFunc>(
                            std::move(*Assert),
                            [](Span<const ComponentValVariant> Args,
                               Span<ComponentValVariant>) -> Expect<void> {
                              const auto &Aggregate =
                                  std::get<std::shared_ptr<ValComp>>(Args[0]);
                              const uint32_t Rep =
                                  std::get<OwnVal>(Aggregate->V).Handle;
      ...
      Host->addHostFunc("return-three",
                        std::make_unique<HostFunc>(
                            std::move(*Three),
                            [](Span<const ComponentValVariant>,
                               Span<ComponentValVariant> Rets) -> Expect<void> {
                              Rets[0] = ComponentValVariant{uint32_t(3)};
                              return {};
                            }));
      ...
      const uint32_t XIdx = Host->addType(std::move(XDT));
      ...
      const uint32_t RecIdx = Host->addType(std::move(RecDT));
      ...
      Nested->addHostFunc(
          ...
          std::make_unique<HostFunc>(
              ...
              [](Span<const ComponentValVariant>,
                 Span<ComponentValVariant> Rets) -> Expect<void> {
                Rets[0] = ComponentValVariant{uint32_t(4)};
                return {};
              }));
      const auto *NestedPtr = Nested.get();
      Host->exportComponentInstance(
          "nested", Host->addComponentInstance(std::move(Nested)));
      (void)NestedPtr;
      ...
      const uint32_t BorIdx = Host->addType(std::move(BorrowDT));
      ...
      auto Simple = std::make_unique<FuncType>(
          std::vector<LabelValType>{
              ...
              LabelValType("rep", ComponentValType(ComponentTypeCode::U32))},
          std::vector<LabelValType>{});
      Host->addHostFunc("[method]resource1.simple",
                        std::make_unique<HostFunc>(
                            std::move(*Simple),
                            [](Span<const ComponentValVariant> Args,
                               Span<ComponentValVariant>) -> Expect<void> {
                              const auto &Aggregate =
                                  std::get<std::shared_ptr<ValComp>>(Args[0]);
                              if (std::get<BorrowVal>(Aggregate->V).Handle !=
      ...
      auto TakeOwn = std::make_unique<FuncType>(
          ...
          std::vector<LabelValType>{});
      Host->addHostFunc("[method]resource1.take-own",
                        std::make_unique<HostFunc>(
                            std::move(*TakeOwn),
                            [Track](Span<const ComponentValVariant> Args,
                                    Span<ComponentValVariant>) -> Expect<void> {
                              // Taking ownership drops the resource on the host
                              // side.
                              const auto &Aggregate =
                                  std::get<std::shared_ptr<ValComp>>(Args[1]);
                              Track->Drops += 1;
                              Track->LastDrop =
                                  std::get<OwnVal>(Aggregate->V).Handle;
                              return {};
      ...
      Host->addHostFunc(
          ...
          std::make_unique<HostFunc>(
              std::move(*TakeBorrow),
              [](Span<const ComponentValVariant>,
                 Span<ComponentValVariant>) -> Expect<void> { return {}; }));
      ...
      Host->addHostFunc(
          ...
          std::make_unique<HostFunc>(
              std::move(*Drops),
              [Track](Span<const ComponentValVariant>,
                      Span<ComponentValVariant> Rets) -> Expect<void> {
                Rets[0] = ComponentValVariant{uint32_t(Track->Drops)};
                return {};
              }));
      ...
      Host->addHostFunc(
          ...
          std::make_unique<HostFunc>(
              ...
              [Track](Span<const ComponentValVariant>,
                      Span<ComponentValVariant> Rets) -> Expect<void> {
                Rets[0] = ComponentValVariant{uint32_t(Track->LastDrop)};
                return {};
              }));
      ...
      Owner->addHostFunc(
          ...
          std::make_unique<HostFunc>(
              ...
              [](Span<const ComponentValVariant>,
                 Span<ComponentValVariant> Rets) -> Expect<void> {
                Rets[0] = ComponentValVariant{uint32_t(2)};
                return {};
              }));
      ...
      Npbth2->exportComponentInstance(
          "x", Npbth2->addComponentInstance(std::move(EmptyX)));
      ...
      const uint32_t U64Idx = InstA->addType(std::move(U64DT));
      ...
      const uint32_t BazIdx = Demo->addType(std::move(BazDT));
      ...
      const uint32_t FooIdx = Demo->addType(std::move(FooDT));
