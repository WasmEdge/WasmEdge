...
TEST_F(WasiCryptoTest, NotImplement) {
  WASI_CRYPTO_EXPECT_FAILURE(symmetricKeyGenerateManaged(1, "SHA-256"sv, std::nullopt),
  ...
  WASI_CRYPTO_EXPECT_FAILURE(symmetricKeyReplaceManaged(1, 1, 1),
            __WASI_CRYPTO_ERRNO_NOT_IMPLEMENTED);
  WASI_CRYPTO_EXPECT_FAILURE(symmetricKeyId(1, {}), __WASI_CRYPTO_ERRNO_NOT_IMPLEMENTED);
  ...
  WASI_CRYPTO_EXPECT_FAILURE(keypairReplaceManaged(1, 1, 1),
            __WASI_CRYPTO_ERRNO_NOT_IMPLEMENTED);
  WASI_CRYPTO_EXPECT_FAILURE(keypairId(1, {}), __WASI_CRYPTO_ERRNO_NOT_IMPLEMENTED);
