...
TEST(JITStackOverflow, RecursiveCallTrap) {
  std::array<WasmEdge::Byte, 70> RecursiveWasm{
      0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x08, 0x02, 0x60,
      0x01, 0x7f, 0x00, 0x60, 0x00, 0x00, 0x03, 0x03, 0x02, 0x00, 0x01, 0x05,
      0x03, 0x01, 0x00, 0x01, 0x07, 0x0a, 0x01, 0x06, 0x5f, 0x73, 0x74, 0x61,
      0x72, 0x74, 0x00, 0x01, 0x0a, 0x1c, 0x02, 0x13, 0x00, 0x20, 0x00, 0x45,
      0x04, 0x40, 0x20, 0x00, 0x10, 0x00, 0x41, 0x00, 0x41, 0x00, 0x36, 0x02,
      0x00, 0x0b, 0x0b, 0x06, 0x00, 0x41, 0x00, 0x10, 0x00, 0x0b};
  ...
  ASSERT_TRUE(VM.loadWasm(RecursiveWasm));
  ASSERT_TRUE(VM.validate());
  ASSERT_TRUE(VM.instantiate());

  auto Result = VM.execute("_start");
  ASSERT_FALSE(Result);
  EXPECT_EQ(Result.error(), WasmEdge::ErrCode::Value::StackOverflow);
}
