...
z13. ARM exceptions use a defined cantunwind table. Standard LLVM ARM personality
tables reference `__aeabi_unwind_cpp_pr0` through an `R_ARM_NONE` dependency
marker, which the linker accepts and discards.
