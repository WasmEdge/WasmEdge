...
public:
  ...
  // Set by the spec test runner before instantiating a component to indicate
  // that component validation should be skipped, so callbacks force-mark the
  // component as validated and instantiation can proceed. thread_local so
  // concurrent spec-test threads do not clobber each other. Only used in spec
  // tests and will be removed when the component model is fully supported.
